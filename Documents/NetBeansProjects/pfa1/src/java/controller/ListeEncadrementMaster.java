 ...
 * @author USER1
 */
@Named(value = "listeEncadrementMaster")
@SessionScoped
public class ListeEncadrementMaster implements Serializable {
...
if(chselected!=null){
 ...
 bytes = bos.toByteArray();
    ...
    /**
     * Creates a new instance of ListeEncadrementMaster
     */
    public ListeEncadrementMaster() {
        
       listeencadmaster= chdao.listEncadrementMaster(ProfilController.ch);
         remplirListImage();
